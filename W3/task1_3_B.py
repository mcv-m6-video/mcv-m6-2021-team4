...
if __name__ == "__main__":
    ...
    if train:
        ...
        cfg.OUTPUT_DIR = 'results/task1_3/strategyB/' + args.model + '/lr_' + str(args.lr).replace('.', '_') + '_iter_' + str(args.iter) + '_batch_' + str(args.batch) + '/' + str(args.set_config) + '/'
    ...
    if evaluate:
        ...
        results_dir = 'results/task1_3/strategyB/test_inference/'
